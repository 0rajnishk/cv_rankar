...
def main():
    ...
    try:
        openai_client = configure_azure_openai(azure_openai_key, azure_openai_endpoint, azure_openai_deployment)
    except Exception as e:
            ...
            with st.spinner("📊 Analyzing resumes..."):
                ...
                for i, resume_blob_name in enumerate(resume_files):
                    ...
                    try:
                        ...
                        response_json = get_azure_openai_response(input_prompt, openai_client, azure_openai_deployment)
